...
public class Driver { //TODO Some skeleton code has been given to you.
    ...
    private void runMainMenu() {
        ...
        while (option != 0) {
            switch (option) {
                ...
                case 5 -> sortAppsByNames();
                case 6 -> printRecommendedApps();
                case 7 -> printRandomApps();
    ...
    private void printRandomApps() {
    }

    private void printRecommendedApps() {
    }

    private void sortAppsByNames() {
    }
